Pod::Spec.new do |s|
  ...
  s.license      = {
    ...
    :text => <<-LICENSE
    ZendeskSDKs
    Created by Zendesk on  6/01/2025
    Copyright (c) 2025 Zendesk. All rights reserved.
  ...
  s.dependency 'ZendeskSDKHTTPClient', '~> 0.20.1'
  s.dependency 'ZendeskSDKStorage', '~> 1.5.0'
  s.dependency 'ZendeskSDKCoreUtilities', '~> 8.0.0'
end